...
const PersonalDetailsScreen = props => {
  ...
  const {firstName, lastName, empId, designation, image, bankInfo} = profile;
  const basicProfileDetail = {firstName, lastName, empId, designation, image};

  const {bankName, bankIfsc, nameOnAccount, bankAccountNo} = bankInfo;

  return (
    <SafeAreaView style={styles.container}>
      <HeadersComponent nav={navigation} title="Bank Info." navAction="back" />
      ...
      <View style={styles.mainListContainer}>
        ...
        <View style={styles.listContainer}>
          ...
          <Text style={[basicStyles.text, basicStyles.flexTow]}>N/A</Text>
        </View>
        ...
        <View style={styles.listContainer}>
          ...
          <Text style={[basicStyles.text, basicStyles.flexTow]}>
            {nameOnAccount ? nameOnAccount : 'N/A'}
          </Text>
        </View>
