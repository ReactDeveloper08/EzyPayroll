...
const PersonalDetailsScreen = (props) => {
  ...
  const {firstName, lastName, empId, designation, image, emplyoymentHistory} =
    profile;
  const basicProfileDetail = {firstName, lastName, empId, designation, image};
  const {
    title,
    organisationOrCompany,
    workLocation,
    fromDate,
    toDate,
    jobDescription,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainListContainer}>
        <View style={styles.listContainer}>
          <Text style={[basicStyles.heading, basicStyles.flexOne]}>Title</Text>
          <Text
            style={[
              basicStyles.heading,
              basicStyles.flexOne,
        ...
        <View style={styles.listContainer}>
          ...
          <Text style={[basicStyles.text, basicStyles.flexTow]}>
            {organisationOrCompany ? organisationOrCompany : 'N/A'}
          </Text>
        </View>
