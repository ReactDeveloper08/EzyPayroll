...
export default class MyITDeclarationsScreen extends Component {
  ...
  listItem = ({item}) => (
    <ITListComponent
      ...
      fetchDeclarationData={this.fetchDeclarationData}
    />
  );
  ...
  handleDetail = () => {
    this.props.navigation.navigate('AddITDeclarations', {
      handleRefresh: this.fetchDeclarationData,
    });
  };
